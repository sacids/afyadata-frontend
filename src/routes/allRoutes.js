...
import ViewDataLists from "pages/Surveys/ViewData"
...
const userRoutes = [
  ...
  { path: "/edit-survey/:projectId/:surveyId", component: EditSurvey},
  { path: "/view-survey-data/:projectId/:surveyId", component: ViewDataLists},
